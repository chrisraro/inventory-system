...
import { QrCode, Search, Download, Trash2, Plus, FileDown } from "lucide-react"
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">View existing QR-based products</p>
            </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    {searchTerm ? "No QR codes match your search." : "Add products to your inventory."}
                  </p>
                  {!searchTerm && (
                    <Button onClick={() => router.push('/add-item')}>
                      <Plus className="h-4 w-4 mr-2" />
