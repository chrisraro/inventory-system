...
-- 14. Sample data for testing (optional - remove if not needed)
/*
INSERT INTO products_simplified (id, qr_code, weight_kg, unit_cost, status, user_id)
VALUES 
    ('LPG-TEST001', 'TEST001', 11, 850.00, 'available', auth.uid()),
    ('LPG-TEST002', 'TEST002', 22, 1200.00, 'available', auth.uid()),
    ('LPG-TEST003', 'TEST003', 50, 2500.00, 'sold', auth.uid())
